...
public class ShapesSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(final int classifierID, final EObject theEObject) {
		...
		case ShapesPackage.GRAPH: {
			final Graph graph = (Graph) theEObject;
		...
		case ShapesPackage.ELLIPSE: {
			final Ellipse ellipse = (Ellipse) theEObject;
		...
		case ShapesPackage.RECTANGLE: {
			final Rectangle rectangle = (Rectangle) theEObject;
		...
		case ShapesPackage.SOLID_LINE: {
			final SolidLine solidLine = (SolidLine) theEObject;
		...
		case ShapesPackage.DASHED_LINE: {
			final DashedLine dashedLine = (DashedLine) theEObject;
	 ...
	 * @generated
	 */
	public T caseGraph(final Graph object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseEllipse(final Ellipse object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseRectangle(final Rectangle object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseSolidLine(final SolidLine object) {
		return null;
	}
	 ...
	 * @generated
	 */
	public T caseDashedLine(final DashedLine object) {
		return null;
	}
