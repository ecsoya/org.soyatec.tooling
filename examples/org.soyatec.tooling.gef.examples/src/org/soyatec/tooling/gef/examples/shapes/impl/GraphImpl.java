 ...
 * <ul>
 * <li>{@link org.soyatec.tooling.gef.examples.shapes.impl.GraphImpl#getShapes
 * <em>Shapes</em>}</li>
 * <li>
 * {@link org.soyatec.tooling.gef.examples.shapes.impl.GraphImpl#getConnections
...
public class GraphImpl extends MinimalEObjectImpl.Container implements Graph {
	/**
	 * The cached value of the '{@link #getShapes() <em>Shapes</em>}'
	...
	protected EClass eStaticClass() {
		return ShapesPackage.Literals.GRAPH;
	}
	...
	public EList<Shape> getShapes() {
		if (shapes == null) {
			shapes = new EObjectContainmentEList<Shape>(Shape.class, this,
					ShapesPackage.GRAPH__SHAPES);
		}
		return shapes;
	}
	...
	public EList<Connection> getConnections() {
		if (connections == null) {
			connections = new EObjectContainmentEList<Connection>(
					Connection.class, this, ShapesPackage.GRAPH__CONNECTIONS);
		}
		return connections;
	}
